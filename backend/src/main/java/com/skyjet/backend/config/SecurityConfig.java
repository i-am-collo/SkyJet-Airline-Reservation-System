package com.skyjet.backend.config;

import com.skyjet.backend.security.JwtAuthenticationFilter;
import com.skyjet.backend.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Authenticated endpoints (auth/me, auth/change-password, bookings)
